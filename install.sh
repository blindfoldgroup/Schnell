...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/schnell-nautilus.py https://raw.githubusercontent.com/umangrajpara99/OpenInSchnell/main/schnell-nautilus.py
